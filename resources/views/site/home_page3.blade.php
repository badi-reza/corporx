...
<div class="main">
    ...
    <section class="hero-equal-height hero-tab-slider pt-165 pb-100 gradient-overly-right-color"
             style="background: url('{{asset('website/img/banner-3.jpg')}}')no-repeat center center / cover">
        <div class="container">
            <div class="row">
                    ...
                    <div class="item">
                        <div class="col-md-8 col-lg-7 col-12">
                            <div class="hero-content-wrap text-white">
                                <span class="text-uppercase">We are here to</span>
                                <h1 class="text-white">Planning Your Business</h1>
        ...
        <ul id="carousel-custom-indicator" class="owl-dots list-inline text-center custom-indicators">
            <li class="list-inline-item">
                <button class="d-flex align-items-center gray-light-bg"><span
                        class="ti-direction-alt icon-sm color-secondary mr-2"></span> Marketing
                </button>
            </li>
            <li class="list-inline-item">
                <button class="d-flex align-items-center gray-light-bg"><span
                        class="ti-wallet icon-sm color-secondary mr-2"></span> Finance
                </button>
            </li>
            <li class="list-inline-item">
                <button class="d-flex align-items-center gray-light-bg"><span
                        class="ti-announcement icon-sm color-secondary mr-2"></span> Consultation
                </button>
            </li>
        </ul>
                ...
                <div class="col-md-12 col-lg-5">
                    <div class="about-content-right mb-md-4 mb-lg-0">
                        ...
                        <p>Objectively productivate installed base technology whereas user friendly ROI.
                            Phosfluorescently innovate functionalized potentialities through.</p>

                        <p>Proactively synergize prospective resources after interoperable e-commerce. Interactively
                            strategize multimedia based vis-a-vis customer directed scenarios proactively
                            enable value.</p>
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="single-promo-block p-4 text-center rounded border my-md-3 my-lg-3 my-sm-0">
                                ...
                                <div class="promo-block-content">
                                    ...
                                    <p>Rapidiously create cooperative resources rather than client-based leadership.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-lg-6">
        ...
        <div class="container">
                ...
                <div class="col-md-8">
                    <div class="section-heading text-center mb-4">
                        ...
                        <p class="lead">
                            ...
                            transform tactical of empowerment .
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="feature-feature-list p-5 text-center border rounded my-md-3 my-lg-3 my-sm-0">
                        <span class="ti-harddrives icon-sm d-block color-secondary mb-3"></span>
                        <h5 class="mb-2">Financial Planning</h5>
                        <p>You can never go wrong with our own top-notch dedicated servers create interoperable</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-feature-list p-5 text-center border rounded my-md-3 my-lg-3 my-sm-0">
                        <span class="ti-rss-alt icon-sm d-block color-secondary mb-3"></span>
                        <h5 class="mb-2">Business Growth</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="feature-feature-list p-5 text-center border rounded my-md-3 my-lg-3 my-sm-0">
                        ...
                        <h5 class="mb-2">Saving Strategy</h5>
                        <p>With full root access you will be able to take full control create interoperable server very easy</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-feature-list p-5 text-center border rounded my-md-3 my-lg-3 my-sm-0">
                        <span class="ti-world icon-sm d-block color-secondary mb-3"></span>
                        <h5 class="mb-2">Business Security</h5>
                        <p>One of many premium features is a dedicated IP cheapest VPS hosting plan create interoperable</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-feature-list p-5 text-center border rounded my-md-3 my-lg-3 my-sm-0">
                        <span class="ti-location-pin icon-sm d-block color-secondary mb-3"></span>
                        <h5 class="mb-2">Total Marketing Solutions</h5>
                        <p>Our VPS hosting plan is fully create interoperable packed with dedicated IPv6 Internet protocol IP</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="feature-feature-list p-5 text-center border rounded my-md-3 my-lg-3 my-sm-0">
                        <span class="ti-thought icon-sm d-block color-secondary mb-3"></span>
                        <h5 class="mb-2">Total SEO Solutions</h5>
                        <p>If you’re not 100% satisfied with Hostlar, create interoperable we’ll refund your payment no risk</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="call-to-action ptb-100 gradient-overlay"
             style="background: url('{{asset('website/img/slider-img-3.jpg')}}')no-repeat top center / cover fixed">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
