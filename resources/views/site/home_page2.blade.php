...
<div class="main">
    ...
    <!--hero section start-->
    <section class="hero-equal-height pt-165 pb-100 gradient-overly-right-color" style="background: url('{{asset('website/img/hero-bg5.jpg')}}')no-repeat center center / cover">
        <div class="container">
            <div class="row">
                <div class="owl-carousel owl-theme hero-content-slider custom-dot custom-dot-2">
                        ...
                        <div class="col-md-8 col-lg-7 col-12">
                            <div class="hero-content-wrap text-white">
                                ...
                                <div class="action-btns mt-4">
                                    <a href="#" class="btn secondary-solid-btn mr-3">Check Prices</a>
                    ...
                    <div class="item">
                        <div class="col-md-8 col-lg-7 col-12">
                            <div class="hero-content-wrap text-white">
                                <span class="text-uppercase">Solutions for Best</span>
                ...
                <div class="col-md-8">
                    <div class="section-heading text-center mb-5">
                        ...
                        <p class="lead">
                            ...
                            transform tactical methods of empowerment.
                        </p>
                    </div>
                </div>
            </div>
