...
<div class="main">
    ...
    <section class="hero-equal-height gradient-overlay pt-165 pb-100 overflow-hidden" style="background: url('img/hero-bg8.jpg')no-repeat center center / cover">
            ...
            <div class="row justify-content-center mt-sm-5 mt-md-5 my-lg-5">
                <div class="col-md-10 col-lg-8">
                    <div class="hero-slider-content text-white text-center position-relative z-index">
                        <h1 class="text-white">Investments Stock & Consultancy Business
                        </h1>
                        <p class="lead">Professionally restore B2B imperatives for cooperative e-tailers. Rapidiously pursue top-line expertise whereas multimedia based technology. Distinctively transform optimal solutions whereas revolutionary sources.</p>

                        <div class="action-btns">
                            <a href="#" class="btn solid-white-btn">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="shape-bottom">
            <img src="{{asset('website/img/curve-shape-top.svg')}}" alt="shape" class="bottom-shape img-fluid">
        </div>
    </section>
                    ...
                    <div class="work-process-wrap text-center">
                        <div class="single-work-process">
                            ...
                            <div class="work-process-content mt-4">
                                ...
                                <p>Compellingly harness reliable methodologies orthogonal services. </p>
                            </div>
                        </div>
                        <div class="single-work-process">
                            <div class="work-process-icon-wrap primary-bg rounded-circle">
                            ...
                            <div class="work-process-content mt-4">
                                ...
                                <p>Credibly coordinate tactical supply chains through equity invested. </p>
                            </div>
                        </div>
                        <div class="single-work-process">
                            <div class="work-process-icon-wrap primary-bg rounded-circle">
                            ...
                            <div class="work-process-content mt-4">
                                <h5>Create Design</h5>
                                <p>Distinctively deploy leveraged web-readiness and frictionless expertise. </p>
                            </div>
                        </div>
                        <div class="single-work-process">
                            <div class="work-process-icon-wrap primary-bg rounded-circle">
                            ...
                            <div class="work-process-content mt-4">
                                ...
                                <p>Objectively evisculate quality customer service for outsourcing.</p>
                            </div>
                        </div>
                    </div>
                </div>
